---
source_url: "https://en.uesp.net/wiki/Skyrim:Scare_my_Enemy"
title: "Skyrim:Scare my Enemy"
entity_type: "quest"
namespace: "Skyrim"
retrieved_at: "2026-05-04T23:45:13.894241+00:00"
tags: ["All Pages Needing Verification", "Skyrim-Bugs Fixed by the Unofficial Skyrim Patch", "Skyrim-Bugs Fixed by the Unofficial Skyrim Special Edition Patch", "Skyrim-Confirmed Bugs", "Skyrim-Pages Needing Verification", "Skyrim-Quests", "Skyrim-Quests with Non-Standard Images", "Skyrim-Quests-Radiant", "Skyrim-Quests-World Interactions", "Skyrim-SRQRP-Requires Final Review"]
---
...
[![](//images.uesp.net/thumb/5/5b/SR-quest-Scare_my_Enemy.jpg/200px-SR-quest-Scare_my_Enemy.jpg)](/wiki/File:SR-quest-Scare_my_Enemy.jpg)
...
- The script on the letter you receive is incomplete. Simply reading the letter will not activate the quest.
  ...
  - To start the quest, you must drop the letter and pick it up again. The letter brings up a debug message when picked up stating that the quest start script needs to be added when books are fully implemented.
    - As part of partial mitigation, the debug message was previously removed in version 1.0 of the Unofficial Skyrim Patch. [*verification needed*]
...
- You can receive the reward even if you decline the quest.
  - The [Unofficial Skyrim Special Edition Patch](/wiki/Skyrim_Mod:Unofficial_Skyrim_Special_Edition_Patch "Skyrim Mod:Unofficial Skyrim Special Edition Patch"), version 4.2.8, addresses this issue. It also prevents receiving the reward if you kill the target.
- Sometimes, the objective "Report success to <Alias=QuestGiver>" will not disappear from quest log.
  - ![PC Only](//images.uesp.net/d/d7/Computer.svg "PC Only") The [Unofficial Skyrim Patch](/wiki/Skyrim_Mod:Unofficial_Skyrim_Patch "Skyrim Mod:Unofficial Skyrim Patch"), version 1.1, fixes this bug.
  - [![On PC](//images.uesp.net/d/d7/Computer.svg)](https://www.wikipedia.org/wiki/PC_game "PC") To get rid of this log entry use the command `CompleteAllObjectives WIAssault02`.
- Children are not immune from being targets.
  - ![PC Only](//images.uesp.net/d/d7/Computer.svg "PC Only") The [Unofficial Skyrim Patch](/wiki/Skyrim_Mod:Unofficial_Skyrim_Patch "Skyrim Mod:Unofficial Skyrim Patch"), version 2.0.5, fixes this bug. ([details](https://afktrack.afkmods.com/index.php?a=issues&i=16217))
- The Male Commoner voice and/or the Male Coward voice are incorrectly used in this quest. [*verification needed*]
...
- This quest can incorrectly pay out rewards even if you kill the target (usually not what the NPC asked for) or if you refuse the quest (obviously shouldn't do that).
...
| 10 |  | *Objective 10:* Meet with <Alias=QuestGiver> about a job involving violence |
| 20 |  | *Objective 20:* Assault <Alias=Enemy> but don't kill <Alias=Enemy.pronoun> |
| 25 |  | *Objective 25:* Assault Alias=Enemy> *[[sic](/wiki/UESPWiki:Spelling#Books_and_Direct_Quotes "UESPWiki:Spelling")]*, killing <Alias=Enemy.pronoun> will earn bonus pay |
| 30 |  | *Objective 30:* Report success to <Alias=QuestGiver> |
| 100 | ☑ |  |
...
- On the PC, it is possible to use the [console](/wiki/Skyrim:Console "Skyrim:Console") to advance through the quest by entering `setstage WIAssault02 stage`, where `stage` is the number of the stage you wish to complete. It is not possible to un-complete (i.e. go back) quest stages, but it is possible to clear all stages of the quest using `resetquest WIAssault02`.
